 ...
 * 
 */
public class MyFileChooser extends JFileChooser implements Accessible {

	/**
	 * 
	 */
	private static final long serialVersionUID = -2217779672230439195L;
	...
	public void setFileFilter(FileFilter filter) {
		...
		if (filter != null) {
			if (isMultiSelectionEnabled() && selectedFiles != null
				...
				if (failed) {
					setSelectedFiles((fList.size() == 0) ? null : fList
							.toArray(new File[fList.size()]));
				}
	...
	private static class WeakPCL implements PropertyChangeListener {
		WeakReference<MyFileChooser> jfcRef;

		public WeakPCL(MyFileChooser jfc) {
			jfcRef = new WeakReference<MyFileChooser>(jfc);
		}

		public void propertyChange(PropertyChangeEvent ev) {
			assert ev.getPropertyName().equals(SHOW_HIDDEN_PROP);
			MyFileChooser jfc = jfcRef.get();
			if (jfc == null) {
	...
	protected String paramString() {
		...
		String currentDirectoryString = (currentDirectory != null ? currentDirectory
				.toString() : "");
	...
	protected class AccessibleJFileChooser extends AccessibleJComponent {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 5728281255714192712L;
